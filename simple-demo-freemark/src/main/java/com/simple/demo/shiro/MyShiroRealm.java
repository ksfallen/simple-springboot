...
import com.simple.demo.model.SysPermission;
import com.simple.demo.model.SysRole;
import com.simple.demo.model.UserInfo;
import com.simple.demo.service.UserInfoService;
...
public class MyShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
       ...
       /*
        * 获取权限信息:这里没有进行实现，
        * 请自行根据 UserInfo,Role,Permission 进行实现；
        ...
        */
        ...
        SimpleAuthenticationInfo authenticationInfo = new SimpleAuthenticationInfo(userInfo, //用户名
                ...
                ByteSource.Util.bytes(userInfo.getCredentialsSalt()), getName()  //realm name
        );
     ...
     * 证明该用户是否允许进行当前操作，如访问某个链接，某个资源文件等。
     *
     * @param principals
     * @return
     */
